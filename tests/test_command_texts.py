"""What `ccdrift` commands and `ccdrift status` say is worded in texts.py, not where it is printed."""
...
def test_every_line_a_command_uses_exists_and_gets_exactly_its_slots(module):
    ...
    tables = {"STATUS_LINES": texts.STATUS_LINES, "COMMAND_LINES": texts.COMMAND_LINES}
    used = 0
