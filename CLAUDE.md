...
- All user-visible wording and formatting lives in src/ccdrift/texts.py, so the check, report and status line stay consistent and the import stays light. Option help is the exception: it stays beside its option in cli.py. tests/test_command_texts.py holds cli.py and status.py to this.
